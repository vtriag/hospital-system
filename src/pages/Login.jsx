    ...
    <>
      ...
      <main className="flex items-center justify-center min-h-screen p-6 bg-gray-100 font-inter">
        <section className="w-full max-w-4xl p-10 bg-white border-2 border-blue-600 shadow-md rounded-2xl">
          <h2 className="mb-8 text-4xl font-semibold text-center text-blue-600">
            Login
          </h2>

          <form
            onSubmit={handleLogin}
            className="max-w-lg mx-auto space-y-8 text-base"
            noValidate
          >
            {/* Nome */}
            <div className="relative p-4 border-2 border-blue-600 rounded-2xl">
              <label
                htmlFor="nome"
                className="absolute px-1 text-sm font-semibold text-blue-600 bg-white select-none -top-3 left-4"
              >
                Nome de usuário *
              </label>
              <input
                ...
                className={`w-full text-base text-blue-900 placeholder-blue-400 bg-transparent border-none outline-none ${
            ...
            <div className="relative p-4 border-2 border-blue-600 rounded-2xl">
              ...
              <select
                id="tipo"
                className="w-full text-base text-blue-900 bg-transparent border-none outline-none"
                value={tipo}
            ...
            <button
              type="submit"
              className="w-full py-4 font-semibold text-white transition-colors duration-300 bg-blue-600 hover:bg-blue-700 rounded-2xl"
            >
              Entrar
            </button>
          </form>
